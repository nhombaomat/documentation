...
Drupal 9 includes many of the features and layout that Drupal 8 user are familiar with, and it removes deprecated code to help improve future Drupal development.
